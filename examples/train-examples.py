...
# Load datasets
train_data = torch.load(r"dataset\qm9s_train_irdata-examples.pt")
valid_data = torch.load(r"dataset\qm9s_valid_irdata-examples.pt")
...
def main():
    ...
    # Save the best model
    torch.save(best_model.state_dict(), "optimal_qm9s_ircnn_examples.pt")
